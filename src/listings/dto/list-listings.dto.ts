...
import { ListingType, ListingStatus, ListingSortOrder, PROPERTY_TYPES } from '../types/listing.types';
...
export class ListingResponseDto {
  ...
  @ApiProperty({ description: 'Тип недвижимости', example: 'apartment', nullable: true })
